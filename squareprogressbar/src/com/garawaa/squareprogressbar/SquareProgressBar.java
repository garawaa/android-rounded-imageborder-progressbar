...
public class SquareProgressBar extends RelativeLayout {
	...
	public SquareProgressBar(Context context, AttributeSet attrs, int defStyle) {
        ...
        //cardView.bringChildToFront(imageView);
	...
	public void setImage(int image) {
		imageId = image;
		mBitmap = BitmapFactory.decodeResource(mResources, image);
		RoundedBitmapDrawable roundedBitmapDrawable = RoundedBitmapDrawableFactory.create(
				mResources,
				mBitmap
		);
		roundedBitmapDrawable.setCornerRadius(bar.getRoundedCornersRadius()/2);
	...
	public void setImageCornerRadius(int radius){
		mBitmap = BitmapFactory.decodeResource(mResources, imageId);
		RoundedBitmapDrawable roundedBitmapDrawable = RoundedBitmapDrawableFactory.create(
				mResources,
				mBitmap
		);
	 ...
	 * checkout {@link #setPercentStyle(com.garawaa.squareprogressbar.utils.PercentStyle)}.
	 * 
	 * @param showProgress
	 *            true if it should or not.
	 * @since 1.3.0
    ...
    public void setRoundedCorners(boolean useRoundedCorners){
        bar.setRoundedCorners(useRoundedCorners, 45);
    }

	public float getRoundedCornersRadius() {
		return bar.getRoundedCornersRadius();
	}
	public void setRoundedCornersRadius(float roundedCornersRadius) {
    	bar.setRoundedCornersRadius(roundedCornersRadius);
	}
    /**
	...
	public void setCenterlineStokeColor(int color) {
		bar.setCenterlineStokeColor(color);
	}
}
